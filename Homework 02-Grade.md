...
| -       | Code could be ran.                                         | pass/fail   |     -30  | ![Alt text][2] |
...
|         | Totals:                                                    | **100**     |  **60** | ![Alt text][2] |

### Comments:
```
No comments, Not in Assignments folder, File is named improperly

  File "Homework", line 24
    if self.denominator == rhs.denominator
                                         ^
SyntaxError: invalid syntax

if you need help see me or Dr Griffin!
```
